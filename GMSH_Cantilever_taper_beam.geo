...
lc = 1.9e-1;   // Mesh size
L = 20;        //Length of beam
H_f = 0.5;     //Height of free end of beam
H_0 = 1;       //Height of clamped end
B = 2;         //Width of beam
...
//
//   Mesh 2;
Save "Cantilever_taper_beam.msh";
//
...
//
Save "Cantilever_taper_beam.inp";
Save "Cantilever_taper_beam.mesh";
//
